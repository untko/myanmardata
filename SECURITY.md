...
If you find a security vulnerability in myanmardata, please report it through [GitHub's private vulnerability reporting](https://github.com/untko/myanmardata/security/advisories/new). This keeps the details private while we work on a fix.
...
**Enterprise support** is available, with priority response SLAs. Contact antkey.ko@gmail.com for details.
